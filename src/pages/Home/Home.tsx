...
export default function Home() {
    ...
    useEffect(() => {
        const removeHeightStyle = () => {
            const totalCarousel = document.querySelector('.react-stacked-center-carousel') as HTMLElement;
            const slide2 = document.querySelector('.react-stacked-center-carousel-slide--2') as HTMLElement;
            const slide1 = document.querySelector('.react-stacked-center-carousel-slide--1') as HTMLElement;
            if (totalCarousel && slide1 && slide2) {
                totalCarousel.style.height = '400px'; // or divElement.style.height = null;
                slide1.style.paddingLeft = '50px'; // or divElement.style.height = null;
                slide2.style.paddingLeft = '100px'; // or divElement.style.height = null;
            }
        };
            ...
            <div className="style-container " ref={bodyWidth}>
                <Grid container>
                    <Stack style={{ display: 'flex', flexDirection: 'column', gap: '0px', justifyContent: 'center', alignItems: 'center', width: '100%' }}>
                            ...
                            <Grid className='relative'>
                                <div className="home-carousel-layout" >
                                    <div className='ml-[176px]'>
                                        <div className='box-gradient absolute h-[60px]' style={{top:'215px'}}>
                                ...
                                <div className='relative w-full' style={{ top: '-122px', left: '6px', width: '80%' }}>
                                    <StackedCarousel
                                        ref={styleRef}
                        ...
                        <div className="m-0 w-full flex justify-center" style={{ backgroundColor: '#171722', zIndex:'11' }}>
