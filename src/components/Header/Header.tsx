...
export default function Header(props: any){
    ...
    const [isRewards, setRewards] = useState(false);
    ...
    const addMenu = () => {
        ...
        if(isCross) {
            ...
            document.getElementsByTagName("main")[0].classList.remove("pt-12");
            ...
            document.getElementsByTagName("main")[0].classList.add("pt-12");
  ...
  return (
    <div>
        <div className="lg:hidden">
              <div className="fixed inset-0 flex top-[48px] hidden" style={{zIndex}} id="subMenu">
                <div className="relative flex-1 flex flex-col w-full pt-5 pb-4 bg-gray-900 max-w-xs">
                  <div className="flex flex-col h-0 flex-1">
                    <div className="flex-1 flex flex-col overflow-y-auto">
                      <div>
                        <nav className="block flex-1 lg:flex"><a aria-current="page" href="https://helixapp.com/"
                            ...
                            ><span className="block">Home</span></a><a href="https://helixapp.com/markets"
                          ...
                          <div className="v-popper v-popper--theme-menu v-popper--theme-dropdown">
                            <div>
                              <div className="relative"><span id="trade-dropdown"
                                  className="hidden lg:block text-gray-200 hover:bg-gray-800 hover:text-white text-sm font-semibold rounded-lg cursor-pointer mx-px h-10 flex lg:flex items-center px-6 hidden lg:block"><span
                                    className="block">Trade</span></span></div>
                            </div>
                          </div>
                          <div className="block lg:hidden">
                            <div className="py-2 px-6">
                              ...
                              <dd className="mt-2" style={{display: 'none'}}>
                              <a href="/swap" className="text-gray-200 hover:bg-gray-800 hover:text-white text-sm font-semibold rounded-lg cursor-pointer mx-px h-10 flex items-center px-6 py-2 hover:bg-gray-800 hover:text-white"
                                  ><span className="block">
                                    <div className="flex items-center gap-2 font-normal tracking-wide">
                                      <p>Swap</p>
                                      <div className="h-4 flex items-center rounded-[4px] px-1 py-1 bg-blue-500"><span
                                          className="text-gray-100 uppercase text-[8px]">New</span></div>
                                    </div>
                                  </span></a><a href="https://helixapp.com/spot/inj-usdt"
                                  className="text-gray-200 hover:bg-gray-800 hover:text-white text-sm font-semibold rounded-lg cursor-pointer mx-px h-10 flex items-center px-6 py-2 hover:bg-gray-800 hover:text-white"
                                  ><span className="block"><span
                                      className="font-normal tracking-wide">Spot</span></span></a><a
                                  href="https://helixapp.com/futures/btc-usdt-perp"
                                  className="text-gray-200 hover:bg-gray-800 hover:text-white text-sm font-semibold rounded-lg cursor-pointer mx-px h-10 flex items-center px-6 py-2 hover:bg-gray-800 hover:text-white"
                                  ><span className="block"><span
                                      className="font-normal tracking-wide">Perpetual</span></span></a><a
                                  href="https://helixapp.com/trading-bots/grid/spot/inj-usdt"
                                  className="text-gray-200 hover:bg-gray-800 hover:text-white text-sm font-semibold rounded-lg cursor-pointer mx-px h-10 flex items-center px-6 py-2 hover:bg-gray-800 hover:text-white"
                                  ><span className="block"><span className="font-normal tracking-wide">Trading
                                      Bots</span></span></a></dd>
                            </div>
                            <div className="py-2 px-6">
                              <dt className="text-lg"><button
                              ...
                              <dd className="mt-2" style={{display: 'none'}}>
                                <div><a href="https://helixapp.com/trade-and-earn"
                                    className="text-gray-200 hover:bg-gray-800 hover:text-white text-sm font-semibold rounded-lg cursor-pointer mx-px h-10 flex items-center px-6 py-2 hover:bg-gray-800 hover:text-white"
                                    ><span className="block"><span className="font-normal tracking-wide">Trade and
                                        Earn</span></span></a><a href="https://helixapp.com/lp-rewards"
                                    className="text-gray-200 hover:bg-gray-800 hover:text-white text-sm font-semibold rounded-lg cursor-pointer mx-px h-10 flex items-center px-6 py-2 hover:bg-gray-800 hover:text-white"
                                    ><span className="block">
                                      <div className="flex gap-1"><span className="font-normal tracking-wide">LP Rewards</span>
                                        <div className="bg-blue-500 rounded-full w-2 h-2 block lg:hidden"></div>
                                      </div>
                                    </span></a><a href="https://helixapp.com/guilds"
                                    className="text-gray-200 hover:bg-gray-800 hover:text-white text-sm font-semibold rounded-lg cursor-pointer mx-px h-10 flex items-center px-6 py-2 hover:bg-gray-800 hover:text-white"
                                    ><span className="block">
                                      <div className="flex gap-1"><span className="font-normal tracking-wide">Guilds</span>
                                        <div className="bg-blue-500 rounded-full w-2 h-2 block lg:hidden"></div>
                                      </div>
                                    </span></a><a
                                    className="text-gray-200 hover:bg-gray-800 hover:text-white text-sm font-semibold rounded-lg cursor-pointer mx-px h-10 flex items-center px-6 py-2"
                                    href="https://trading.injective.network/program/liquidity" target="_blank"><span
                                      className="font-normal tracking-wide">Open Liquidity Program</span></a></div>
                              </dd>
                            </div>
                          ...
                          <div className="v-popper v-popper--theme-menu v-popper--theme-dropdown">
                            <div>
                              <div className="relative"><span id="rewards-dropdown"
                                ...
                                <div
                                  className="bg-blue-500 rounded-full w-2 h-2 absolute right-3.5 top-2.5 hidden lg:block">
                                </div>
                              </div>
                            </div>
                          </div>
        ...
        <div className="cursor-pointer pl-6 lg:pr-6 lg:border-r flex items-center" onClick={goHome}>
        ...
        <div className="flex-1 px-2 lg:px-6 flex justify-end lg:justify-between">
            ...
            <div className="hidden lg:block">
                ...
                <div className="v-popper v-popper--theme-menu v-popper--theme-dropdown" 
                    ...
                    {isDropdownVisible && <ul className="rounded absolute text-gray-850 pt-1 pb-1 group-hover:block popup-menu" style={{top: '42px', left: '-30px'}}>
                        <li className="p-4 block  group hover:bg-gray-700 relative z-50 bg-gray-850">
                        <a href="/swap" data-cy="header-swap-link">
                            <div className="flex items-center gap-2.5">
                                <p className="font-semibold text-base text-white">Swap</p>
                            </div>
                            <p className="text-sm text-gray-500 group-hover:text-gray-100 mt-1">Trade through a simple &amp; intuitive
                                interface</p>
                            </a>
                        </li>
                        <li className="p-4 block group hover:bg-gray-700 relative z-50 bg-gray-850">
                        <a href="https://helixapp.com/spot/inj-usdt" data-cy="header-trade-link">
                            <p className="font-semibold text-base text-white">Spot</p>
                            <p className="text-sm text-gray-500 group-hover:text-gray-100 mt-1">Trade crypto on an on-chain orderbook</p>
                            </a>
                        </li>
                        <li className="p-4 block group hover:bg-gray-700 relative z-50 bg-gray-850">
                        <a href="https://helixapp.com/futures/btc-usdt-perp" data-cy="header-trade-link">
                            <p className="font-semibold text-base text-white">Perpetual</p>
                            <p className="text-sm text-gray-500 group-hover:text-gray-100 mt-1">Trade perpetual contracts settled in USDT
                            </p>
                            </a>
                        </li>
                        <li className="p-4 block group hover:bg-gray-700 relative z-50 bg-gray-850">
                        <a href="https://helixapp.com/trading-bots/grid/spot/inj-usdt/" 
                            ...
                            <div className="flex items-center gap-2.5">
                                <p className="font-semibold text-base text-white">Trading Bots</p>
                                <div className="bg-blue-500 text-gray-100 rounded-[4px] px-1.5 py-0.5 uppercase text-[8px]">New</div>
                            </div>
                            <p className="text-sm text-gray-500 group-hover:text-gray-100 mt-1">Trade smarter with automated strategies
                            </p>
                            </a>
                        </li>
                    </ul>}
                ...
                <div className="v-popper v-popper--theme-menu v-popper--theme-dropdown" onMouseEnter={handleRewardEnter}
                    ...
                    {isRewards && <ul className="rounded absolute text-gray-850 pt-1 pb-1 group-hover:block popup-menu" style={{top: '42px', left: '150px'}}>
                        <li className="p-4 block  group hover:bg-gray-700 relative z-50 bg-gray-850">
                            <a href="https://helixapp.com/trade-and-earn">
                                <p className="font-semibold text-base text-white">Trade and Earn</p>
                                <p className="text-sm text-gray-500 group-hover:text-gray-100 mt-1">Earn rewards with every trade</p>
                            </a>
                        </li>
                        <li className="p-4 block group hover:bg-gray-700 relative z-50 bg-gray-850">
                        <a href="https://helixapp.com/lp-rewards">
                            <div className="flex items-center gap-2.5">
                                <p className="font-semibold text-base text-white">LP Rewards</p>
                                <div className="bg-blue-500 text-gray-100 rounded-[4px] px-1.5 py-0.5 uppercase text-[8px]">New</div>
                            </div>
                            <p className="text-sm text-gray-500 group-hover:text-gray-100 mt-1">Rewards for using liquidity bots</p>
                            </a>
                        </li>
                        <li className="p-4 block group hover:bg-gray-700 relative z-50 bg-gray-850">
                        <a href="https://helixapp.com/guilds">
                            <div className="flex items-center gap-2.5">
                                <p className="font-semibold text-base text-white">Guilds</p>
                                <div className="bg-blue-500 text-gray-100 rounded-[4px] px-1.5 py-0.5 uppercase text-[8px]">New</div>
                            </div>
                            <p className="text-sm text-gray-500 group-hover:text-gray-100 mt-1">Team up with other traders to earn rewards
                            </p>
                            </a>
                        </li>
                        <li className="p-4 block group hover:bg-gray-700 relative z-50 bg-gray-850">
                        <a href="https://trading.injective.network/program/liquidity" target="_blank">
                            <p className="font-semibold text-base text-white flex items-center"><span>Open Liquidity Program</span><svg
                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                                className="cursor-pointer w-auto h-3 ml-2">
                            ...
                            <p className="text-sm text-gray-500 group-hover:text-gray-100 mt-1">Provide liquidity and earn INJ rewards in
                                our Open Liquidity Program</p>
                            </a>
                        </li>
                    </ul>}
                </div>
        ...
        <button className="px-4 border-r border-gray-600 text-gray-200 lg:hidden" onClick={addMenu}>
            {!isCross ? <svg
